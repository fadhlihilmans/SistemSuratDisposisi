...
<section class="section">
    <div class="section-header">
        ...
        <h1>{{ $formAdd ? 'Tambah Bidang' : 'Edit Bidang' }}</h1>
    </div>
    ...
    <div class="section-body">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header"><h4>Form Bidang / Urusan</h4></div>
                    <div class="card-body">
                        <form wire:submit.prevent="{{ $formAdd ? 'add' : 'update' }}" autocomplete="off">
                        <!-- Nama -->
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Nama Bidang / Urusan</label>
                ...
                <div class="card">
                    <div class="card-header d-flex flex-column align-items-start">
                        <div class="w-100 d-flex justify-content-between align-items-center mb-2">
                            <h4 class="mb-0">List Bidang / Urusan</h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped mb-0">
                                ...
                                <tbody>
                                    @forelse ($listBidang as $item)
                                    <tr>
                                        <td class="text-center">{{ $loop->iteration + ($listBidang->firstItem() - 1) }}</td>
                                        <td>{{ $item->nama }}</td>
