...
<section class="section">
    <div class="section-header">
        ...
        <h1>{{ $formAdd ? 'Tambah Kode Surat' : 'Edit Kode Surat' }}</h1>
    </div>
    ...
    <div class="section-body">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header"><h4>Form Kode Surat</h4></div>
                    <div class="card-body">
                        ...
                        <!-- kode Surat -->
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control" wire:model.defer="kode">
                ...
                <div class="card">
                    <div class="card-header d-flex flex-column align-items-start">
                        <div class="w-100 d-flex justify-content-between align-items-center mb-2">
                            <h4 class="mb-0">List Kode Surat</h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped mb-0">
                                ...
                                <tbody>
                                    @forelse ($listKodeSurat as $item)
                                    <tr>
                                        <td class="text-center">{{ $loop->iteration + ($listKodeSurat->firstItem() - 1) }}</td>
                                        <td>{{ $item->kode }}</td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Apakah Anda yakin ingin menghapus kode surat ini?</p>
            </div>
